...
var countdownTimer = setInterval(function() {
    timeLeft--;
    document.getElementById("timerr").textContent = timeLeft;
    document.getElementById("timerr1").textContent = timeLeft;
    ...
    if (timeLeft <= 0) {
        ...
        window.location.href = "https://t.me/+S2VcLWlRNQAxMmNl";
    }
}, 1000);
